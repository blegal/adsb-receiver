#include "Detector_AVX2_Inter.hpp"

#ifdef __AVX2__
    #include <immintrin.h>
#endif

Detector_AVX2_Inter::Detector_AVX2_Inter() : Detector(1)
{

}

void Detector_AVX2_Inter::execute(std::vector<float>* iBuffer, std::vector<float>* oBuffer)
{
#ifdef __AVX2__
